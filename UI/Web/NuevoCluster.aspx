<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Menu.Master" AutoEventWireup="true" CodeBehind="NuevoCluster.aspx.cs" Inherits="UI.Web.NuevoCluster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <dx:ASPxFormLayout ID="FormLayout" ClientInstanceName="FormLayout" runat="server" RequiredMarkDisplayMode="Auto" UseDefaultPaddings="false" AlignItemCaptionsInAllGroups="true" Width="100%" ColumnCount="2">
        ...
        <Items>
            <dx:LayoutGroup Caption="Nuevo Cluster" GroupBoxDecoration="Box" ColumnCount="1">
...
<Paddings Padding="0px"></Paddings>
    ...
    <dx:ASPxGridView ID="GPermisos" runat="server" AutoGenerateColumns="False" CssFilePath="~/App_Themes/RedWine/{0}/styles.css"
        ...
        <asp:SqlDataSource ID="SQLCompania" runat="server" ConnectionString="Data Source=10.144.10.100;Initial Catalog=Pruebas;Persist Security Info=True;User ID=sa
                    ;Password=SAsoftladbqa$" ProviderName="System.Data.SqlClient" SelectCommand="SELECT C.CONJUNTO,C.CONJUNTO + ' ' + C.NOMBRE AS NOMBRE FROM PRUEBAS.ERPADMIN.CONJUNTO C
                WHERE C.CONJUNTO NOT IN (SELECT DISTINCT CIA FROM PORTAL.dbo.DETALLE_CLUSTER_AF) ORDER BY 2">
        </asp:SqlDataSource>
