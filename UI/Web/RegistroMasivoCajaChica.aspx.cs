...
namespace UI.Web
{
    public partial class RegistroMasivoCajaChica : System.Web.UI.Page
    {
        ...
        public string revisarExcel(string path, string filename)
        {
            ...
            try
            {
                ...
                if (num3 == 0)
                {
                    ...
                    do
                    {
                        ...
                        //string pfecha2 = pfecha.ToString().Substring(3, 2) + "/" + pfecha.ToString().Substring(0, 2) + "/" + pfecha.ToString().Substring(6, 4);
                        ...
                        //pfecha_vale = pfecha_vale.ToString().Substring(3, 2) + "/" + pfecha_vale.ToString().Substring(0, 2) + "/" + pfecha_vale.ToString().Substring(6, 4);
            ...
            catch (Exception ex)
            {
                ...
                String VSQL;
                VSQL = "delete from PORTAL.dbo.CARGADOR_VALES_MASIVO";
                ...
                //text = "Ocurrió un error en la carga del archivo, revisar la información del archivo excel.";
                text = ex.Message;
                //throw;
            }
            return text;
        ...
        private string EjecutarCargaCajasChicas(string PCIA)
        {
            ...
            {
                using (var conn = new SqlConnection(VconnectionString))
                using (var command = new SqlCommand("PORTAL.[dbo].[PORTAL_PROCESAR_VALES_2]", conn)
                {
