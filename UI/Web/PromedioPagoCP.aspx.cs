...
namespace UI.Web
{
    public partial class PromedioPagoCP : System.Web.UI.Page
    {
        ...
        {
            if (Session["ci_sciaPP"] == null)
            {
                Session["ci_sciaPP"] = "ddd ffffff";
                ...
                ((Lform.FindItemOrGroupByName("TipoDocumento") as LayoutItem).GetNestedControl() as ASPxComboBox).Value = "%";
            }
        }
        ...
        private void BuscarDocumentos()
        {
            ...
            LayoutItem itemTipo = Lform.FindItemOrGroupByName("TipoDocumento") as LayoutItem;
            ...
            if (CBFechaInicial != null)
            {
                ...
                if (CBCia.Value != null)
                {
                    Session["ci_sciaPP"] = CBCia.Value != null ? CBCia.Value.ToString() : "XXX;";
                }
                else
                {
                    Session["ci_sciaPP"] = "XXX XXXXXXXXXX";
                }
