...
namespace UI.Web
{
    public partial class Monitorf_LibroComprasTest : System.Web.UI.Page
    {
...
//                ((Lform.FindItemOrGroupByName("CiaOrigen") as LayoutItem).GetNestedControl() as ASPxGridLookup).Value = "";
        ...
        protected void ASPxFormLayout1_E3_ClickExc(object sender, EventArgs e)
        {
            ...
            //GridExterior.ExportToXlsx(stream2);
            //WriteToResponse("LibroComprasExterior.xlsx", true, "vnd.openxmlformats-officedocument.spreadsheetml.sheet", stream2);
            //System.IO.MemoryStream stream3 = new System.IO.MemoryStream();
            //GridTransito.ExportToXlsx(stream3);
            //WriteToResponse("LibroComprasTransito.xlsx", true, "vnd.openxmlformats-officedocument.spreadsheetml.sheet", stream3);
