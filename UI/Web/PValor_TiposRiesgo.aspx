<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Menu.Master" AutoEventWireup="true" CodeBehind="PValor_TiposRiesgo.aspx.cs" Inherits="UI.Web.PValor_TiposRiesgo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" Text="              Palancas - Tipos Riesgo"></asp:Label>
    <br />
    <br />
...
ORDER BY CodigoTipoRiesgo" InsertCommand="INSERT INTO Portal.PValor.TiposRiesgo
(
	TipoRiesgo
	, Activo
)
...
(
	@TipoRiesgo
	, @Activo
)" UpdateCommand="UPDATE Portal.PValor.TiposRiesgo
SET 
TipoRiesgo=@TipoRiesgo
, Activo=@Activo
WHERE CodigoTipoRiesgo=@CodigoTipoRiesgo">
        <InsertParameters>
            <asp:Parameter Name="TipoRiesgo" />
        ...
        <UpdateParameters>
            ...
            <asp:Parameter Name="CodigoTipoRiesgo" />
                ...
                <dx:ASPxGridViewExporter runat="server" GridViewID="ASPxGridView1" FileName="TiposRiesgo" ExportedRowType="All" ID="ASPxGridViewExporter1"></dx:ASPxGridViewExporter>

    <br />
    <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SQLTiposRiesgo" KeyFieldName="CodigoTipoRiesgo" Theme="SoftOrange" Width="427px">
...
<HeaderFilter MinHeight="140px"></HeaderFilter>
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="TipoRiesgo" LoadReadOnlyValueFromDataModel="True" VisibleIndex="2">
