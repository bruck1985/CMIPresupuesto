<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Menu.Master" AutoEventWireup="true" CodeBehind="UsuarioDepartamentoActivo.aspx.cs" Inherits="UI.Web.UsuarioDepartamentoActivo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" Text="Usuario Cluster Departamento"></asp:Label>
    <br />
    <br />
    ...
    <table style="width: 700px; height: 192px">
        <tr>
            <td>
                &nbsp;</td>
            <td>
        ...
        <tr>
            <td>
                <dx:ASPxGridView ID="GPermisos" runat="server" AutoGenerateColumns="False" CssFilePath="~/App_Themes/RedWine/{0}/styles.css"
                    CssPostfix="RedWine" DataSourceID="SQLUbicaciones" KeyFieldName="CODIGO" 
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="NOMBRE_CLUSTER" FixedStyle="Left" ReadOnly="True" Caption="Cluster"
                            VisibleIndex="0">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="CIA" FixedStyle="Left" ReadOnly="True" Caption="Compañia"
                            VisibleIndex="1">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="NOMBRE_CIA" FixedStyle="Left" VisibleIndex="2" Caption="Nombre Compañia"
                            Width="100%">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="UBICACION" FixedStyle="Left" VisibleIndex="3" Caption="Departamento"
                            Width="100%">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="DESCRIPCION" FixedStyle="Left" VisibleIndex="4" Caption="Nombre Departamento"
                            Width="100%">
                        </dx:GridViewDataTextColumn>
                    </Columns>
                    <StylesEditors>
                ...
                <dx:ASPxGridView ID="GPermisosExcel" runat="server" Visible="false" AutoGenerateColumns="False" CssFilePath="~/App_Themes/RedWine/{0}/styles.css"
                    CssPostfix="RedWine" DataSourceID="SQLUbicacionesExcel" KeyFieldName="CODIGO" 
                    Width="700px" ClientInstanceName="grid" EnableRowsCache="False" Theme="SoftOrange">
                    <ImagesFilterControl>
                        <LoadingPanel Url="~/App_Themes/RedWine/Editors/Loading.gif">
                        </LoadingPanel>
                ...
                <asp:SqlDataSource ID="SQLUbicaciones" runat="server" ConnectionString="Data Source=10.144.10.100;Initial Catalog=PRUEBAS;Persist Security Info=True;User ID=sa
            ;Password=SAsoftladbqa$" ProviderName="System.Data.SqlClient" SelectCommand="PORTAL.[dbo].[PORTAL_DEPARTAMENTOS_AF]" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:SessionParameter DefaultValue="0" Name="Usuario" SessionField="usuarioConsulta" Size="200" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
                
                <asp:SqlDataSource ID="SQLUbicacionesExcel" runat="server" ConnectionString="Data Source=10.144.10.100;Initial Catalog=PRUEBAS;Persist Security Info=True;User ID=sa
            ;Password=SAsoftladbqa$" ProviderName="System.Data.SqlClient" SelectCommand="PORTAL.[dbo].[PORTAL_DEPARTAMENTOS_AF_EXCEL]" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:SessionParameter DefaultValue="0" Name="Usuario" SessionField="usuarioConsulta" Size="200" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>

                <dx:ASPxGridViewExporter ID="grid_data_exp" runat="server" FileName="Usuarios_Departamentos" GridViewID="GPermisos">
                </dx:ASPxGridViewExporter>

                <dx:ASPxGridViewExporter ID="grid_data_exp_excel" runat="server" FileName="Usuarios_Departamentos" GridViewID="GPermisosExcel">
                </dx:ASPxGridViewExporter>
