<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Menu.Master" AutoEventWireup="true" CodeBehind="PValor_DashPalancaKPI.aspx.cs" Inherits="UI.Web.PValor_DashPalancaKPI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <dx:ASPxDashboard ID="ASPxDashboard1" runat="server" DashboardXmlPath="~/App_Data/Dashboards/DashPalancaKPI.xml" OnDashboardSaving="ASPxDashboard1_DashboardSaving" ColorScheme="light.compact" OnCustomPalette="ASPxDashboard1_CustomPalette" OnSetInitialDashboardState="ASPxDashboard1_SetInitialDashboardState" WorkingMode="ViewerOnly">
    </dx:ASPxDashboard>
</asp:Content>
