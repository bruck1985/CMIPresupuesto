<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Menu.Master" AutoEventWireup="true" CodeBehind="PValor_Tecnologias.aspx.cs" Inherits="UI.Web.PValor_Tecnologias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" Text="              Palancas - Tecnología"></asp:Label>
    <br />
    <br />
...
ORDER BY CodigoTecnologia" InsertCommand="INSERT INTO Portal.PValor.Tecnologias
(
	Tecnologia
	, Activo
)
...
(
	@Tecnologia
	, @Activo
)" UpdateCommand="UPDATE Portal.PValor.Tecnologias
SET 
Tecnologia=@Tecnologia
, Activo=@Activo
WHERE CodigoTecnologia=@CodigoTecnologia">
        <InsertParameters>
        ...
        <UpdateParameters>
            ...
            <asp:Parameter Name="CodigoTecnologia" />
                ...
                <dx:ASPxGridViewExporter runat="server" GridViewID="ASPxGridView1" FileName="Tecnologias" ExportedRowType="All" ID="ASPxGridViewExporter1"></dx:ASPxGridViewExporter>

    <br />
    <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SQLTecnologias" KeyFieldName="CodigoTecnologia" Theme="SoftOrange" Width="427px">
...
<HeaderFilter MinHeight="140px"></HeaderFilter>
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="Tecnologia" LoadReadOnlyValueFromDataModel="True" VisibleIndex="2">
