...
namespace UI.Web
{
    public partial class TransaccionesInventarios : System.Web.UI.Page
    {
        ...
        {
            if (Session["ci_sciaTI"] == null)
            {
                Session["ci_sciaTI"] = "ddd ffffff";
        ...
        private void BuscarDocumentos()
        {
            ...
            if (CBFechaInicial != null)
            {
                if (CBCia.Value != null)
                {
                    Session["ci_sciaTI"] = CBCia.Value != null ? CBCia.Value.ToString() : "XXX;";
                }
                else
                {
                    Session["ci_sciaTI"] = "XXX XXXXXXXXXX";
                }
