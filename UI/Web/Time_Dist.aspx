<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Menu.Master" AutoEventWireup="true" CodeBehind="Time_Dist.aspx.cs" Inherits="UI.Web.Time_Dist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" Text="              Time Distribución proyectos"></asp:Label>
    <br />
    <br />
    ...
    <asp:SqlDataSource ID="SQLTimeSheet" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConexionPortal %>" ProviderName="<%$ ConnectionStrings:SQLConexionPortal.ProviderName %>" SelectCommand="portal.[Time].[Genera]" InsertCommand="INSERT INTO PORTAL.[Presupuesto].[DATA] (AREA,COD_PAIS, CIA,  CENTRO_COSTO, DESCRIPCION, CATEGORIA, CUENTA_CONTABLE, 
...
where ID = @ID" SelectCommandType="StoredProcedure" >
    ...
    <dx:ASPxPivotGrid ID="Grid" runat="server" ClientIDMode="AutoID" DataSourceID="SQLTimeSheet" Theme="Office365" ClientInstanceName="PivotCompra">
        <Fields>
            <dx:PivotGridField ID="fieldMONTOREDISTRIB" Area="DataArea" AreaIndex="1" FieldName="MONTO_REDISTRIB" Name="fieldMONTOREDISTRIB" CellFormat-FormatString="#,###" CellFormat-FormatType="Numeric" GrandTotalCellFormat-FormatString="#,###" GrandTotalCellFormat-FormatType="Numeric" TotalCellFormat-FormatString="#,###" TotalCellFormat-FormatType="Numeric" TotalValueFormat-FormatString="#,###" ValueFormat-FormatString="#,###">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldPESORELATIVO" Area="DataArea" AreaIndex="2" FieldName="PESO_RELATIVO" Name="fieldPESORELATIVO" CellFormat-FormatString="#,###.00%" CellFormat-FormatType="Numeric" GrandTotalCellFormat-FormatString="#,###.00%" GrandTotalCellFormat-FormatType="Numeric" TotalCellFormat-FormatString="#,###.00%" TotalCellFormat-FormatType="Numeric" TotalValueFormat-FormatString="#,###.00%" ValueFormat-FormatString="#,###.00%">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldPESORELATIVOPROY" Area="DataArea" AreaIndex="3" FieldName="PESO_RELATIVO_PROY" Name="fieldPESORELATIVOPROY" CellFormat-FormatString="#,###.00%" CellFormat-FormatType="Numeric" GrandTotalCellFormat-FormatString="#,###.00%" GrandTotalCellFormat-FormatType="Numeric" TotalCellFormat-FormatString="#,###.00%" TotalCellFormat-FormatType="Numeric" TotalValueFormat-FormatString="#,###.00%" ValueFormat-FormatString="#,###.00%">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldHORASNOFACTURABLES" Area="DataArea" AreaIndex="4" FieldName="HORAS_NO_FACTURABLES" Name="fieldHORASNOFACTURABLES" CellFormat-FormatString="#,###" CellFormat-FormatType="Numeric" GrandTotalCellFormat-FormatString="#,###" GrandTotalCellFormat-FormatType="Numeric" TotalCellFormat-FormatString="#,###" TotalCellFormat-FormatType="Numeric" TotalValueFormat-FormatString="#,###" ValueFormat-FormatString="#,###">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldCOSTOSINDNOLABORALES" Area="DataArea" AreaIndex="5" FieldName="COSTOS_IND_NO_LABORALES" Name="fieldCOSTOSINDNOLABORALES" CellFormat-FormatString="#,###" CellFormat-FormatType="Numeric" GrandTotalCellFormat-FormatString="#,###" GrandTotalCellFormat-FormatType="Numeric" TotalCellFormat-FormatString="#,###" TotalCellFormat-FormatType="Numeric" TotalValueFormat-FormatString="#,###" ValueFormat-FormatString="#,###">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldMARGEN" AreaIndex="7" FieldName="MARGEN" Name="fieldMARGEN" Area="DataArea" CellFormat-FormatString="#,###.00%" CellFormat-FormatType="Numeric" GrandTotalCellFormat-FormatString="#,###.00%" GrandTotalCellFormat-FormatType="Numeric" TotalCellFormat-FormatString="#,###.00%" TotalCellFormat-FormatType="Numeric" TotalValueFormat-FormatString="#,###.00%" ValueFormat-FormatString="#,###.00%">
            </dx:PivotGridField>
            <dx:PivotGridField ID="field6" AreaIndex="6" Name="field6" Area="DataArea" Caption="COSTO_TOTAL" UnboundExpression="[fieldMONTOREDISTRIB] + [fieldHORASNOFACTURABLES] + [fieldCOSTOSINDNOLABORALES]" UnboundFieldName="COSTO_TOTAL" UnboundType="Decimal" CellFormat-FormatString="#,###" CellFormat-FormatType="Numeric" GrandTotalCellFormat-FormatString="#,###" GrandTotalCellFormat-FormatType="Numeric" TotalCellFormat-FormatString="#,###" TotalCellFormat-FormatType="Numeric" TotalValueFormat-FormatString="#,###" ValueFormat-FormatString="#,###">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldACTIVIDAD" AreaIndex="0" FieldName="ACTIVIDAD" Name="fieldACTIVIDAD" Area="RowArea">
            </dx:PivotGridField>
            <dx:PivotGridField ID="field" Area="DataArea" AreaIndex="9" Caption="FAC_ACT" Name="field" UnboundExpression="[COSTO_TOTAL] * (1 + IsNull([MARGEN], 0)) - IsNull([FACT_ANT], 0)" UnboundFieldName="field" UnboundType="Decimal"  CellFormat-FormatString="#,###.00" CellFormat-FormatType="Numeric" GrandTotalCellFormat-FormatString="#,###.00" GrandTotalCellFormat-FormatType="Numeric" TotalCellFormat-FormatString="#,###.00" TotalCellFormat-FormatType="Numeric" TotalValueFormat-FormatString="#,###.00" ValueFormat-FormatString="#,###.00">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldFACTANT" Area="DataArea" AreaIndex="8" FieldName="FACT_ANT" Name="fieldFACTANT"  CellFormat-FormatString="#,###.00" CellFormat-FormatType="Numeric" GrandTotalCellFormat-FormatString="#,###.00" GrandTotalCellFormat-FormatType="Numeric" TotalCellFormat-FormatString="#,###.00" TotalCellFormat-FormatType="Numeric" TotalValueFormat-FormatString="#,###.00" ValueFormat-FormatString="#,###.00">
            </dx:PivotGridField>
            ...
            <dx:PivotGridField ID="fieldRELEMPLEADO" AreaIndex="0" FieldName="REL_EMPLEADO" Name="fieldRELEMPLEADO">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldRELEMPLEADONOM" AreaIndex="1" FieldName="REL_EMPLEADO_NOM" Name="fieldRELEMPLEADONOM">
            </dx:PivotGridField>
        </Fields>
