<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Menu.Master" AutoEventWireup="true" CodeBehind="PValor_TemasResponsables.aspx.cs" Inherits="UI.Web.PValor_TemasResponsables" %>
        ...
        <tr>
            <td>
                ...
                <asp:SqlDataSource ID="DS_Usuarios" runat="server" ConnectionString="Data Source=10.144.10.10;Initial Catalog=me;Persist Security Info=True;User ID=PortalRep; Password=P0rta1R3p.2766$"
                    ProviderName="System.Data.SqlClient" SelectCommand='SELECT Usu.Usuario
      , Usu.Nombre AS Nombre
	  , Resp.Responsable
FROM ME.erpadmin.USUARIO AS Usu
INNER JOIN PValor.Responsables AS Resp
