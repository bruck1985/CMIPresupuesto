...
;Password=P0rta1R3p.2766$" ProviderName="System.Data.SqlClient" SelectCommand="SELECT VERSION, CAST(VERSION AS VARCHAR(10)) + ' ' + DESCRIPCION DESCRIPCION 
FROM [PORTAL].[Presupuesto].versionamiento WHERE ANO = 2022 order by 1" DeleteCommand="DELETE [PORTAL].[Presupuesto].[PAIS]
WHERE COD_PAIS = @COD_PAIS" InsertCommand="INSERT INTO [PORTAL].[Presupuesto].[PERIODOS]
           (ANO, PERIODO, ESTADO_PRESUPUESTO, ESTADO_FORECAST)
     VALUES (@ANO, @PERIODO, @ESTADO_PRESUPUESTO, @ESTADO_FORECAST)" UpdateCommand="Update [PORTAL].[Presupuesto].[PERIODOS]
set PERIODO = @PERIODO, ESTADO_PRESUPUESTO = @ESTADO_PRESUPUESTO, ESTADO_FORECAST = @ESTADO_FORECAST
...
<HeaderFilter MinHeight="140px"></HeaderFilter>
        ...
        <Columns>
            ...
            <dx:GridViewDataComboBoxColumn FieldName="VERSION" LoadReadOnlyValueFromDataModel="True" VisibleIndex="5">
                <PropertiesComboBox DataSourceID="SQLVersion" TextField="DESCRIPCION" ValueField="VERSION">
                </PropertiesComboBox>
