<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Menu.Master" AutoEventWireup="true" CodeBehind="PValor_Sociedades.aspx.cs" Inherits="UI.Web.PValor_Sociedades" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" Text="              Palancas - Sociedades"></asp:Label>
    <br />
    <br />
...
ORDER BY CodigoSociedad" InsertCommand="INSERT INTO Portal.PValor.Sociedades
(
	Sociedad
	, Activo
)
...
(
	@Sociedad
	, @Activo
)" UpdateCommand="UPDATE Portal.PValor.Sociedades
SET 
Sociedad=@Sociedad
, Activo=@Activo
WHERE CodigoSociedad=@CodigoSociedad">
        <InsertParameters>
            <asp:Parameter Name="Sociedad" />
        ...
        <UpdateParameters>
            ...
            <asp:Parameter Name="CodigoSociedad" />
                ...
                <dx:ASPxGridViewExporter runat="server" GridViewID="ASPxGridView1" FileName="Sociedades" ExportedRowType="All" ID="ASPxGridViewExporter1"></dx:ASPxGridViewExporter>

    <br />
    <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SQLSociedades" KeyFieldName="CodigoSociedad" Theme="SoftOrange" Width="427px">
...
<HeaderFilter MinHeight="140px"></HeaderFilter>
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="Sociedad" LoadReadOnlyValueFromDataModel="True" VisibleIndex="2">
