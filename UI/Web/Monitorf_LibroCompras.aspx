<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Menu.Master" AutoEventWireup="true" CodeBehind="Monitorf_LibroCompras.aspx.cs" Inherits="UI.Web.Monitorf_LibroCompras" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SQLComprasTransacciones" runat="server" ConnectionString="Data Source=10.144.10.10;Initial Catalog=me;Persist Security Info=True;User ID=PortalRep
;Password=P0rta1R3p.2766$" ProviderName="System.Data.SqlClient" SelectCommand="PORTAL.MonitorF.SPLibroComprasTransacciones" SelectCommandType="StoredProcedure">
    ...
    <asp:SqlDataSource ID="SQLComprasServiciosExterior" runat="server" ConnectionString="Data Source=10.144.10.10;Initial Catalog=me;Persist Security Info=True;User ID=PortalRep
;Password=P0rta1R3p.2766$" ProviderName="System.Data.SqlClient" SelectCommand="PORTAL.MonitorF.SPLibroComprasServiciosExterior" SelectCommandType="StoredProcedure">
    ...
    <asp:SqlDataSource ID="SQLComprasTransaccionesExcluidas" runat="server" ConnectionString="Data Source=10.144.10.10;Initial Catalog=me;Persist Security Info=True;User ID=PortalRep
...
<%--        <Templates>
  ...
  <dx:ASPxGridViewExporter ID="GridExporterCompras" runat="server" GridViewID="GridCompras"></dx:ASPxGridViewExporter>
      <dx:ASPxGridViewExporter ID="GridExporterExterior" runat="server" GridViewID="GridExterior"></dx:ASPxGridViewExporter>
             <br />
    <br />
    <br />
    <br />
