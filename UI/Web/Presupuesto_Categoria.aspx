<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Menu.Master" AutoEventWireup="true" CodeBehind="Presupuesto_Categoria.aspx.cs" Inherits="UI.Web.Presupuesto_Categoria" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" Text="              Presupuesto Categoria"></asp:Label>
    <br />
    <br />
...
WHERE CENTRO_COSTO= @CENTRO_COSTO">
        ...
        <UpdateParameters>
            ...
            <asp:Parameter Name="CENTRO_COSTO" />
                ...
                <dx:ASPxGridViewExporter runat="server" GridViewID="ASPxGridView1" FileName="Categorias" ExportedRowType="All" ID="ASPxGridViewExporter1"></dx:ASPxGridViewExporter>

    <br />
    <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SQLCategoria" Theme="SoftOrange" Width="427px" KeyFieldName="CATEGORIA">
...
<HeaderFilter MinHeight="140px"></HeaderFilter>
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="CATEGORIA" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="1">
