<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Menu.Master" AutoEventWireup="true" CodeBehind="PValor_PalancasValorMant2.aspx.cs" Inherits="UI.Web.PValor_PalancasValorMant2" %>
...
;Password=P0rta1R3p.2766$" ProviderName="System.Data.SqlClient" SelectCommand="Portal.PValor.SPTraePalancasValor2" SelectCommandType="StoredProcedure" DeleteCommand="Portal.PValor.spBorraPalancasValor" DeleteCommandType="StoredProcedure" InsertCommand="Portal.PValor.spRegistraPalancasValorMant2" InsertCommandType="StoredProcedure" UpdateCommand="Portal.PValor.spRegistraPalancasValorMant2" UpdateCommandType="StoredProcedure">
        <DeleteParameters>
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="ComentarioImpactoUNAPeriodo" Type="String" />
            <asp:Parameter Name="MontoImpactoCajaPeriodo" Type="Int32" />
            <asp:Parameter Name="ComentarioImpactoCajaPeriodo" Type="String" />
           ...
           <dx:GridViewDataComboBoxColumn FieldName="Periodo" LoadReadOnlyValueFromDataModel="True" VisibleIndex="2" Width="70px">
            ...
            <dx:GridViewDataTextColumn FieldName="MontoImpactoUNAPeriodo" LoadReadOnlyValueFromDataModel="True" VisibleIndex="12" Caption="Monto Impacto UNA Periodo (miles)" Width="100px">
                ...
                <ExportCellStyle HorizontalAlign="Center" Wrap="True">
                    ...
                    <dx:GridViewDataMemoColumn FieldName="ComentarioImpactoUNAPeriodo" VisibleIndex="13" Width="100px" Caption="Comentario ImpactoUNAPeriodo">
                        <PropertiesMemoEdit Height="80px" MaxLength="500" Width="800px">
                            <Style Wrap="True">
                            </Style>
                        </PropertiesMemoEdit>
...
<%--            <dx:GridViewDataTextColumn FieldName="CodigoImpactoUNAPeriodo" LoadReadOnlyValueFromDataModel="True" VisibleIndex="13" ReadOnly="True">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CodigoImpactoUNAPeriodo" LoadReadOnlyValueFromDataModel="True" VisibleIndex="14" Caption="Impacto UNA Periodo" Width="110px">
            ...
            <dx:GridViewDataTextColumn FieldName="MontoImpactoCajaPeriodo" LoadReadOnlyValueFromDataModel="True" VisibleIndex="15" Caption="Monto Impacto Caja Periodo (miles)" Width="100px">
                <ExportCellStyle HorizontalAlign="Center" Wrap="True">
                </ExportCellStyle>
            </dx:GridViewDataTextColumn>

                    <dx:GridViewDataMemoColumn FieldName="ComentarioImpactoCajaPeriodo" VisibleIndex="16" Width="100px" Caption="Comentario ImpactoCajaPeriodo">
                        <PropertiesMemoEdit Height="80px" MaxLength="500" Width="800px">
                            <Style Wrap="True">
                            </Style>
                        </PropertiesMemoEdit>
...
<%--            <dx:GridViewDataTextColumn FieldName="CodigoImpactoCajaPeriodo" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="15">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CodigoImpactoCajaPeriodo" LoadReadOnlyValueFromDataModel="True" VisibleIndex="17" Caption="Impacto Caja Periodo" Width="110px">
                <PropertiesComboBox DataSourceID="SQLImpactos" TextField="Impacto" ValueField="CodigoImpacto">
                </PropertiesComboBox>
                <EditFormSettings Visible="False" />
                <ExportCellStyle HorizontalAlign="Center" Wrap="True">
            ...
            <dx:GridViewDataTextColumn FieldName="MontoImpactoUNALP" LoadReadOnlyValueFromDataModel="True" VisibleIndex="18" Caption="Monto Impacto UNA LP (miles)" Width="100px">
                <ExportCellStyle HorizontalAlign="Center" Wrap="True">
                </ExportCellStyle>
            </dx:GridViewDataTextColumn>
<%--            <dx:GridViewDataTextColumn FieldName="CodigoImpactoUNALP" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="17">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CodigoImpactoUNALP" LoadReadOnlyValueFromDataModel="True" VisibleIndex="19" Caption="Impacto UNA LP" Width="110px">
                <PropertiesComboBox DataSourceID="SQLImpactos" TextField="Impacto" ValueField="CodigoImpacto">
                </PropertiesComboBox>
                <EditFormSettings Visible="False" />
                <ExportCellStyle HorizontalAlign="Center" Wrap="True">
            ...
            <dx:GridViewDataTextColumn FieldName="MontoImpactoCajaLP" LoadReadOnlyValueFromDataModel="True" VisibleIndex="20" Caption="Monto Impacto Caja LP (miles)" Width="100px">
                <ExportCellStyle HorizontalAlign="Center" Wrap="True">
                </ExportCellStyle>
            </dx:GridViewDataTextColumn>
<%--            <dx:GridViewDataTextColumn FieldName="CodigoImpactoCajaLP" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="19">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CodigoImpactoCajaLP" LoadReadOnlyValueFromDataModel="True" VisibleIndex="21" Caption="Impacto Caja LP" Width="110px">
                <PropertiesComboBox DataSourceID="SQLImpactos" TextField="Impacto" ValueField="CodigoImpacto">
                </PropertiesComboBox>
                <EditFormSettings Visible="False" />
                <ExportCellStyle HorizontalAlign="Center" Wrap="True">
...
<%--            <dx:GridViewDataTextColumn FieldName="CodigoProbabilidadOcurrenciaRiesgoInherente" LoadReadOnlyValueFromDataModel="True" VisibleIndex="20">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CodigoProbabilidadOcurrenciaRiesgoInherente" LoadReadOnlyValueFromDataModel="True" VisibleIndex="22" Caption="Probabilidad Ocurrencia Riesgo Inherente" Width="120px">
            ...
            <dx:GridViewDataTextColumn FieldName="MontoImpactoRiesgoInherente" LoadReadOnlyValueFromDataModel="True" VisibleIndex="23" Caption="Monto Impacto Riesgo Inherente (miles)" Width="100px">
                <ExportCellStyle HorizontalAlign="Center" Wrap="True">
                </ExportCellStyle>
            </dx:GridViewDataTextColumn>
<%--            <dx:GridViewDataTextColumn FieldName="CodigoImpactoRiesgoInherente" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="22">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CodigoImpactoRiesgoInherente" LoadReadOnlyValueFromDataModel="True" VisibleIndex="24" Caption="Impacto Riesgo Inherente" Width="110px">
                <PropertiesComboBox DataSourceID="SQLImpactos" TextField="Impacto" ValueField="CodigoImpacto">
                </PropertiesComboBox>
                <EditFormSettings Visible="False" />
                <ExportCellStyle HorizontalAlign="Center" Wrap="True">
...
<%--            <dx:GridViewDataTextColumn FieldName="CodigoCriticidadRiesgoInherente01" LoadReadOnlyValueFromDataModel="True" VisibleIndex="23">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CodigoCriticidadRiesgoInherente01" ReadOnly="True" LoadReadOnlyValueFromDataModel="True" VisibleIndex="25" Caption="Indice Criticidad Riesgo Inherente" Width="170px">
            ...
            <dx:GridViewDataTextColumn FieldName="CodigoCriticidadRiesgoInherente02" LoadReadOnlyValueFromDataModel="True" VisibleIndex="26" Caption="Criticidad Riesgo Inherente" Width="80px">
                <EditFormSettings Visible="False" />
                <ExportCellStyle HorizontalAlign="Center" Wrap="True">
                </ExportCellStyle>
            </dx:GridViewDataTextColumn>
...
<%--            <dx:GridViewDataTextColumn FieldName="Mitigadores" LoadReadOnlyValueFromDataModel="True" VisibleIndex="25">
                    ...
                    <dx:GridViewDataMemoColumn FieldName="Mitigadores" VisibleIndex="27" Width="100px">
...
<%--            <dx:GridViewDataTextColumn FieldName="CodigoProbabilidadOcurrenciaRiesgoResidual" LoadReadOnlyValueFromDataModel="True" VisibleIndex="26">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CodigoProbabilidadOcurrenciaRiesgoResidual" LoadReadOnlyValueFromDataModel="True" VisibleIndex="28" Caption="Probabilidad Ocurrencia Riesgo Residual" Width="100px">
                <PropertiesComboBox DataSourceID="SQLProbabilidades" TextField="Probabilidad" ValueField="CodigoProbabilidad">
                </PropertiesComboBox>
                <ExportCellStyle HorizontalAlign="Center" Wrap="True">
                </ExportCellStyle>
            ...
            <dx:GridViewDataTextColumn FieldName="MontoImpactoRiesgoResidualUNA" LoadReadOnlyValueFromDataModel="True" VisibleIndex="29" Caption="Monto Impacto Riesgo Residual UNA (miles)" Width="100px">
                <ExportCellStyle HorizontalAlign="Center" Wrap="True">
                </ExportCellStyle>
            </dx:GridViewDataTextColumn>
<%--            <dx:GridViewDataTextColumn FieldName="CodigoImpactoRiesgoResidualUNA" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="28">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CodigoImpactoRiesgoResidualUNA" LoadReadOnlyValueFromDataModel="True" VisibleIndex="30" Caption="Impacto Riesgo Residual UNA" Width="100px">
                <PropertiesComboBox DataSourceID="SQLImpactos" TextField="Impacto" ValueField="CodigoImpacto">
                </PropertiesComboBox>
                <EditFormSettings Visible="False" />
                <ExportCellStyle HorizontalAlign="Center" Wrap="True">
            ...
            <dx:GridViewDataTextColumn FieldName="MontoImpactoRiesgoResidualFlujo" LoadReadOnlyValueFromDataModel="True" VisibleIndex="31" Caption="Monto Impacto Riesgo Residual Flujo (miles)" Width="100px">
                <ExportCellStyle HorizontalAlign="Center" Wrap="True">
                </ExportCellStyle>
            </dx:GridViewDataTextColumn>
<%--            <dx:GridViewDataTextColumn FieldName="CodigoImpactoRiesgoResidualFlujo" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="30">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CodigoImpactoRiesgoResidualFlujo" LoadReadOnlyValueFromDataModel="True" VisibleIndex="32" Caption="Impacto Riesgo Residual Flujo" Width="100px">
                <PropertiesComboBox DataSourceID="SQLImpactos" TextField="Impacto" ValueField="CodigoImpacto">
                </PropertiesComboBox>
                <EditFormSettings Visible="False" />
                <ExportCellStyle HorizontalAlign="Center" Wrap="True">
...
<%--            <dx:GridViewDataTextColumn FieldName="CodigoCriticidadRiesgoResidual01" LoadReadOnlyValueFromDataModel="True" VisibleIndex="31">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CodigoCriticidadRiesgoResidual01" ReadOnly="True" LoadReadOnlyValueFromDataModel="True" VisibleIndex="33" Caption="Indice Criticidad Riesgo Residual" Width="170px">
                <PropertiesComboBox DataSourceID="SQLCriticidades" TextField="Criticidad" ValueField="CodigoCriticidad">
                </PropertiesComboBox>
                <EditFormSettings Visible="False" />
                <ExportCellStyle HorizontalAlign="Center" Wrap="True">
            ...
            <dx:GridViewDataTextColumn FieldName="CodigoCriticidadRiesgoResidual02" LoadReadOnlyValueFromDataModel="True" VisibleIndex="34" Caption="Criticidad Riesgo Residual" Width="80px" ReadOnly="True">
                <EditFormSettings Visible="False" />
                <ExportCellStyle HorizontalAlign="Center" Wrap="True">
                </ExportCellStyle>
            </dx:GridViewDataTextColumn>
<%--            <dx:GridViewDataComboBoxColumn FieldName="CodigoCriticidadRiesgoResidual02" ReadOnly="True" LoadReadOnlyValueFromDataModel="True" VisibleIndex="32" Caption="CriticidadRiesgoResidual" Width="120px">
            ...
            <dx:GridViewDataDateColumn FieldName="PlazoResolucion" LoadReadOnlyValueFromDataModel="True" VisibleIndex="35" Width="100px" Caption="Plazo Resolucion">
                <ExportCellStyle HorizontalAlign="Center" Wrap="True">
                </ExportCellStyle>
            </dx:GridViewDataDateColumn>
<%--                    <dx:GridViewDataTextColumn FieldName="AccionesCursoEnergia" LoadReadOnlyValueFromDataModel="True" VisibleIndex="34">
            </dx:GridViewDataTextColumn>--%>
                    <dx:GridViewDataMemoColumn FieldName="AccionesCursoEnergia" VisibleIndex="36" Width="100px" Caption="Acciones Curso Energia">
                        <PropertiesMemoEdit Height="80px" MaxLength="500">
                        </PropertiesMemoEdit>
                        <Settings AllowEllipsisInText="True" />
                        <ExportCellStyle HorizontalAlign="Center" Wrap="True">
...
<%--            <dx:GridViewDataTextColumn FieldName="AccionesAltoNivel" LoadReadOnlyValueFromDataModel="True" VisibleIndex="35">
                    ...
                    <dx:GridViewDataMemoColumn FieldName="AccionesAltoNivel" VisibleIndex="37" Width="100px" Caption="Acciones Alto Nivel">
                        <PropertiesMemoEdit Height="80px" MaxLength="500">
                            <Style Wrap="True">
                            </Style>
                        </PropertiesMemoEdit>
...
<%--            <dx:GridViewDataTextColumn FieldName="CodigoEstadoPalanca" LoadReadOnlyValueFromDataModel="True" VisibleIndex="36">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CodigoEstadoPalanca" LoadReadOnlyValueFromDataModel="True" VisibleIndex="38" Caption="Estado Palanca">
