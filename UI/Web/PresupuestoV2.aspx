<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Menu.Master" AutoEventWireup="true" CodeBehind="PresupuestoV2.aspx.cs" Inherits="UI.Web.PresupuestoV2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" Text="              Reporte Web Presupuesto V2"></asp:Label>
    <br />
    <br />
    ...
    <asp:SqlDataSource ID="SQLPresupuesto" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConexionPruebas %>" ProviderName="<%$ ConnectionStrings:SQLConexionPruebas.ProviderName %>" SelectCommand="SELECT ID, AREA,COD_PAIS, CIA,  CENTRO_COSTO, DESCRIPCION, CATEGORIA, CUENTA_CONTABLE, 
...
, REGLA FROM [PORTAL].[Presupuesto].[DATA] D
...
<HeaderFilter MinHeight="140px"></HeaderFilter>
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="ANO" LoadReadOnlyValueFromDataModel="True" VisibleIndex="9" ShowInCustomizationForm="True" Visible="False">
                ...
                <dx:GridViewBandColumn Caption="Año 2024" VisibleIndex="12">
                ...
                <dx:GridViewBandColumn Caption="Año 2025" VisibleIndex="13">
                    <HeaderStyle HorizontalAlign="Center" />
                    <Columns>
           ...
           <dx:GridViewDataComboBoxColumn FieldName="CATEGORIA" LoadReadOnlyValueFromDataModel="True" VisibleIndex="8">
                <PropertiesComboBox EnableCallbackMode="true" DataSourceID="SQLCATEGORIA" TextField="DESCRIPCION" ValueField="CATEGORIA" Width="200px">
                    <ValidationSettings RequiredField-IsRequired="true"><RequiredField IsRequired="True"></RequiredField>
                    </ValidationSettings>
                </PropertiesComboBox>
            </dx:GridViewDataComboBoxColumn>
           <dx:GridViewDataComboBoxColumn FieldName="REGLA" LoadReadOnlyValueFromDataModel="True" VisibleIndex="9">
                <PropertiesComboBox EnableCallbackMode="true" DataSourceID="SQLREGLA" TextField="DESCRIPCION" ValueField="REGLA" Width="200px">
                    <ValidationSettings RequiredField-IsRequired="true"><RequiredField IsRequired="True"></RequiredField>
                    </ValidationSettings>
                </PropertiesComboBox>
            </dx:GridViewDataComboBoxColumn>
           <dx:GridViewDataComboBoxColumn FieldName="REGLA2" LoadReadOnlyValueFromDataModel="True" VisibleIndex="10">
                <PropertiesComboBox EnableCallbackMode="true" DataSourceID="SQLREGLA2" TextField="DESCRIPCION" ValueField="REGLA" Width="200px">
                    <ValidationSettings RequiredField-IsRequired="true"><RequiredField IsRequired="True"></RequiredField>
                    </ValidationSettings>
                </PropertiesComboBox>
            </dx:GridViewDataComboBoxColumn>
    ...
    <asp:SqlDataSource ID="SQLArea" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConexionPruebas %>" ProviderName="<%$ ConnectionStrings:SQLConexionPruebas.ProviderName %>" SelectCommand="SELECT [AREA]
      ,[DESCRIPCION]
  ...
  order by 2">
    ...
    <asp:SqlDataSource ID="SQLCuentaContable" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConexionPruebas %>" ProviderName="<%$ ConnectionStrings:SQLConexionPruebas.ProviderName %>" SelectCommand="SELECT [CUENTA_CONTABLE], [CUENTA_CONTABLE] + ' ' + [DESCRIPCION] DESCRIPCION
  FROM [PORTAL].[Presupuesto].[CUENTA_CONTABLE]
  order by 1">
    </asp:SqlDataSource>

    <asp:SqlDataSource ID="SQLPeriodos" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConexionPruebas %>" ProviderName="<%$ ConnectionStrings:SQLConexionPruebas.ProviderName %>" SelectCommand="select ano from portal.[Presupuesto].[PERIODOS] order by 1">
    </asp:SqlDataSource>

        
    <asp:SqlDataSource ID="SQLCategoria" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConexionPruebas %>" ProviderName="<%$ ConnectionStrings:SQLConexionPruebas.ProviderName %>" SelectCommand="SELECT [CATEGORIA],[DESCRIPCION] FROM [PORTAL].[Presupuesto].[CATEGORIA]">
    </asp:SqlDataSource>

    <asp:SqlDataSource ID="SQLRegla" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConexionPruebas %>" ProviderName="<%$ ConnectionStrings:SQLConexionPruebas.ProviderName %>" SelectCommand="SELECT [REGLA],[DESCRIPCION] FROM [PORTAL].[Presupuesto].[REGLA]">
    </asp:SqlDataSource>

        
    <asp:SqlDataSource ID="SQLCia" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConexionPruebas %>" ProviderName="<%$ ConnectionStrings:SQLConexionPruebas.ProviderName %>" SelectCommand="SELECT [CONJUNTO], [NOMBRE] NOMBRE
  FROM [PORTAL].[Presupuesto].[CIA]
ORDER BY 1">
    </asp:SqlDataSource>

        
    <asp:SqlDataSource ID="SQLPresupuestoNoModificable" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConexionPruebas %>" ProviderName="<%$ ConnectionStrings:SQLConexionPruebas.ProviderName %>" SelectCommand="SELECT ID, AREA,COD_PAIS, CIA,  CENTRO_COSTO, DESCRIPCION, CATEGORIA, CUENTA_CONTABLE, 
ANO, ENERO, FEBRERO, MARZO, ABRIL, MAYO, JUNIO, JULIO, AGOSTO, SEPTIEMBRE, OCTUBRE, NOVIEMBRE, DICIEMBRE, FENERO, FFEBRERO, FMARZO, FABRIL, FMAYO, FJUNIO, FJULIO, FAGOSTO, FSEPTIEMBRE, FOCTUBRE, FNOVIEMBRE, FDICIEMBRE, YAGENERO, YAGFEBRERO, YAGMARZO, YAGABRIL, YAGMAYO, YAGJUNIO, YAGJULIO, YAGAGOSTO, YAGSEPTIEMBRE, YAGOCTUBRE, YAGNOVIEMBRE, YAGDICIEMBRE
