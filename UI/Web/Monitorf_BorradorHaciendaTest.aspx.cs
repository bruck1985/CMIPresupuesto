...
namespace UI.Web
{
    ...
    public partial class Monitorf_BorradorHaciendaTest : System.Web.UI.Page
    {

        public string CiaIDBorradorHacienda;
...
//                ((Lform.FindItemOrGroupByName("CiaOrigen") as LayoutItem).GetNestedControl() as ASPxGridLookup).Value = "";
            ...
            //XtraReport rpt = new UI.Web.XtraReportBorradorHaciendav2Test
            //    //dxKB2796.XtraReport1
            //{
            ...
            //    //RequestParameters = false
            //    //Parameters()
            //    //Parameters.GetByName("pcia2").Value = "CROMSA"
            //    //rpt.Parameters["pcia2"].Value = "CROMSA";
            //    //rpt.Parameters.GetByName("pcia2").Value = "CROMSA";
            //    //    rpt.Parameters("pcia").Value = "CROMSA"
            //    //rpt.Parameters.GetByName("pcia").Value = "CROMSA"
            ...
            //rpt.DataSourceDemanded += Report_DataSourceDemanded;


            //XtraReport rpt2 = new UI.Web.XtraReportBorradorHaciendav2Test
            //{
            //    RequestParameters = false
            //    //RequestParameters = false
            //    //Parameters()
            ...
            //rpt2.DataSourceDemanded += Report_DataSourceDemanded;



            //CiaIDGeneral = Session["lista_ci_scia1"].ToString();
            //CiaIDXtraReport = "IEO2";



            //rpt.Parameters.GetByName("pcia").Value = "IEO2";

            //CiaIDXtraReport = Session["lista_ci_scia1"].ToString()


            //rpt.Parameters.GetByName("pcia").Value = Session["bclista_ci_scia"].ToString();
            //    rpt.Parameters.GetByName("pcia").Value = Session["lista_ci_scia1"].ToString();
            //rpt.Parameters["pcia"].Value = "CROMSA";
            //rpt.Parameters.GetByName("pcia").Value = "CROMSA";
        ...
        protected void ASPxFormLayout1_E3_Click(object sender, EventArgs e)
        {
            ...
            XtraReport rpt = new UI.Web.XtraReportBorradorHaciendav2Test();
            //rpt.Parameters["pcia"].Value = "IEO2";
            rpt.Parameters["pcia"].Value = Session["lista_ci_scia1"];
            rpt.Parameters["pfechainicio"].Value = Session["ci_sfec1"];
            rpt.Parameters["pfechafinal"].Value = Session["ci_sfec2"];
            //ASPxWebDocumentViewer1Test.ReportSourceId = UI.Web.XtraReportBorradorHaciendav2Test;

            

            ASPxWebDocumentViewer1Test.OpenReport(rpt);
        ...
        protected void ASPxFormLayout1_E3_ClickExc(object sender, EventArgs e)
        {
            ...
            //PivotVenta.OptionsView.HideAllTotals();
            System.IO.MemoryStream stream = new System.IO.MemoryStream();
            ASPxPivExp1.ExportToXlsx(stream);
            WriteToResponse("BorradorImpuesto.xlsx", true, "vnd.openxmlformats-officedocument.spreadsheetml.sheet", stream);
            //PivotVenta.OptionsView.ShowAllTotals();
