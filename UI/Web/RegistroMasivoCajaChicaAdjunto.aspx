<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Menu.Master" AutoEventWireup="true" CodeBehind="RegistroMasivoCajaChicaAdjunto.aspx.cs" Inherits="UI.Web.RegistroMasivoCajaChicaAdjunto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" Text="Cargador Masivo Caja Chicas Adjunto"></asp:Label>
    <br />
    <br />
    ...
    <br />
     ...
     <dx:ASPxGridView ID="GridRenta" runat="server" AutoGenerateColumns="False" DataSourceID="SQLConta" ClientInstanceName="grid" KeyFieldName="ID"  >
         <ClientSideEvents CustomButtonClick="function(s, e) {  visibleIndex = grid.GetRowKey(e.visibleIndex);  if (e.buttonID == 'btdet1') {Popup.PerformCallback(visibleIndex); Popup.Show(); }  
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="ID" LoadReadOnlyValueFromDataModel="True" VisibleIndex="4">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="DEPARTAMENTO" LoadReadOnlyValueFromDataModel="True" VisibleIndex="5">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="CAJA_CHICA" LoadReadOnlyValueFromDataModel="True" VisibleIndex="6">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="CONSECUTIVO_VALE" LoadReadOnlyValueFromDataModel="True" VisibleIndex="7">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="FECHA_EMISION" LoadReadOnlyValueFromDataModel="True" VisibleIndex="8">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="FECHA_LIQUIDACION" LoadReadOnlyValueFromDataModel="True" VisibleIndex="9">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="CONCEPTO_VALE" LoadReadOnlyValueFromDataModel="True" VisibleIndex="10">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="BENEFICIARIO" LoadReadOnlyValueFromDataModel="True" VisibleIndex="11">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="MONTO_TOTAL_CAJA" LoadReadOnlyValueFromDataModel="True" VisibleIndex="12">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="MONTO_TOTAL_LOCAL" LoadReadOnlyValueFromDataModel="True" VisibleIndex="13">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="MONTO_TOTAL_DOLAR" LoadReadOnlyValueFromDataModel="True" VisibleIndex="14">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="TIPO_CAMBIO_DOLAR" LoadReadOnlyValueFromDataModel="True" VisibleIndex="15">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="PRESUPUESTO" LoadReadOnlyValueFromDataModel="True" VisibleIndex="16">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="LINEA" LoadReadOnlyValueFromDataModel="True" VisibleIndex="17">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="CENTRO_COSTO" LoadReadOnlyValueFromDataModel="True" VisibleIndex="18">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="CUENTA_CONTABLE" LoadReadOnlyValueFromDataModel="True" VisibleIndex="19">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="CONTRIBUYENTE" LoadReadOnlyValueFromDataModel="True" VisibleIndex="20">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="NRO_DOCUMENTO" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="21">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="TIPO_DOCUMENTO" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="22">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="MONTO_TOTAL_LINEA" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="23">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="CONCEPTO_LINEA_VALE" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="24">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="DETALLE" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="25">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="FECHA_LINEA_VALE" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="26">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="TIPO_IMPUESTO" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="27">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="SUB_TOTAL_LINEA" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="28">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="IMPUESTO_IVA_LINEA" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="29">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="IMPUESTO_CONSUMO_LINEA" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="30">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="TIPO_AFECTACION" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="31">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="ACTIVIDAD_COMERCIAL_LINEA" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="32">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="ACTIVIDAD_D104_LINEA" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="33">
            </dx:GridViewDataTextColumn>
        </Columns>
    ...
    <dx:ASPxPopupControl ID="Popup" runat="server" AllowDragging="True" ClientInstanceName="Popup" CloseAction="OuterMouseClick" HeaderText="Vales" Modal="true" OnWindowCallback="Popup_WindowCallback"  PopupAction="None" PopupElementID="grid" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" ShowCloseButton="false" ScrollBars="Vertical" ShowPageScrollbarWhenModal="True" ShowViewportScrollbarWhenModal="True" Height="400px" Width="900px">
        <ContentCollection>
            <dx:PopupControlContentControl runat="server">
                ...
                <table style="width: 100%;">
                    <tr>
                        <td>
                            <dx:ASPxFileManager ID="ASPxFileManager1" runat="server" DataSourceID="SQL_Data_Vale_Doc_Adjuntos" Height="380px" Width="200px" OnFileDownloading="ASPxFileManager1_FileDownloading" ClientInstanceName="filemanager" OnCustomCallback="ASPxFileManager1_CustomCallback">
                                <SettingsDataSource />
                ...
                <asp:SqlDataSource ID="SQL_Data_Vale_Doc_Adjuntos" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConexionPruebas %>" ProviderName="<%$ ConnectionStrings:SQLConexionPruebas.ProviderName %>" SelectCommand="PORTAL.[dbo].[PORTAL_DOCUMENTOS_ADJUNTOS_VALE]" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:SessionParameter DefaultValue="0" Name="CARGADOR_ID" SessionField="CodigoCargadorVale" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
