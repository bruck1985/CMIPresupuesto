<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Menu.Master" AutoEventWireup="true" CodeBehind="Time_DistSMT.aspx.cs" Inherits="UI.Web.Time_DistSMT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" Text="              Time Distribución proyectos SMT"></asp:Label>
    <br />
    <br />
    ...
    <asp:SqlDataSource ID="SQLTimeSheet" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConexionPortal %>" ProviderName="<%$ ConnectionStrings:SQLConexionPortal.ProviderName %>" SelectCommand="portal.[Time].[GeneraSMT]" InsertCommand="INSERT INTO PORTAL.[Presupuesto].[DATA] (AREA,COD_PAIS, CIA,  CENTRO_COSTO, DESCRIPCION, CATEGORIA, CUENTA_CONTABLE, 
...
where ID = @ID" SelectCommandType="StoredProcedure" >
    ...
    <dx:ASPxPivotGrid ID="Grid" runat="server" ClientIDMode="AutoID" DataSourceID="SQLTimeSheet" Theme="Office365" ClientInstanceName="PivotCompra">
        <Fields>
            ...
            <dx:PivotGridField ID="field" Area="DataArea" AreaIndex="8" Caption="FAC_ACT" Name="field" UnboundExpression="[COSTO_TOTAL] * (1 + IsNull([MARGEN], 0))" UnboundFieldName="field" UnboundType="Decimal">
            </dx:PivotGridField>
