<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Menu.Master" AutoEventWireup="true" CodeBehind="EditarInventario.aspx.cs" Inherits="UI.Web.EditarInventario" %>
            ...
            <dx:LayoutGroup Caption="Editar Estado" GroupBoxDecoration="Box" ColumnCount="1">
                ...
                <Items>
                    ...
                    <dx:LayoutItem Caption="Responsable Activo" Name="LiResponsableActivo">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer>
                                <dx:ASPxTextBox ID="txtResponsableActivo" runat="server" NullText="Responsable Activo" Width="100%" CssClass="maxWidth" MaxLength="100">
                                </dx:ASPxTextBox>
                            </dx:LayoutItemNestedControlContainer>
                        </LayoutItemNestedControlCollection>
                    </dx:LayoutItem>
                    ...
                    <dx:LayoutItem Caption="Fecha Ultimo Inventario" Name="LiFechaUltimoInventario">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer>
                                <dx:ASPxDateEdit ID="dtFechaInventario"  runat="server" CssClass="maxWidth"  Width="100%"></dx:ASPxDateEdit>
                            </dx:LayoutItemNestedControlContainer>
                        </LayoutItemNestedControlCollection>
                    </dx:LayoutItem>
        ...
        <dx:PopupControlContentControl runat="server">
            <table style="width:100%;">
                ...
                <tr>
                    <td class="auto-style8"></td>
                    <td class="auto-style3" colspan="3">
                        <dx:ASPxLabel ID="ASPxLabel1" runat="server" Font-Bold="True" Text="Ya existe una solicitud de cambio de Estado pendiente de aprobar o rechazar." style="margin-left: 7px" Width="300px">
                            <DisabledStyle Font-Bold="True">
                            </DisabledStyle>
                        </dx:ASPxLabel>
                    </td>
