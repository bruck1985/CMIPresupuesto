<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Menu.Master" AutoEventWireup="true" CodeBehind="ProveedoresV3.aspx.cs" Inherits="UI.Web.ProveedoresV3" %>
...
" Name="PUsuarioCia" SessionField="nombreUsuario" Size="200" Type="String" />
    ...
    <dx:ASPxPivotGrid ID="PivotCompra" runat="server" ClientIDMode="AutoID" DataSourceID="SQLCompras" Theme="Office365" ClientInstanceName="PivotCompra">
        <Fields>
            ...
            <dx:PivotGridField ID="fieldCATEGORIAPROVEED" Area="RowArea" AreaIndex="26" FieldName="CATEGORIA_PROVEED" Name="fieldCATEGORIAPROVEED" Visible="False">
            </dx:PivotGridField>
            ...
            <dx:PivotGridField ID="fieldCONTRIBUYENTE" FieldName="CONTRIBUYENTE" Name="fieldCONTRIBUYENTE" Area="RowArea" AreaIndex="6">
            </dx:PivotGridField>
...
<dx:PivotGridField FieldName="RUBRO4_PROVEEDOR" Name="fieldRUBRO4PROVEEDOR" ID="fieldRUBRO4PROVEEDOR" Visible="False" AreaIndex="0"></dx:PivotGridField>
            ...
            <dx:PivotGridField ID="fieldUPROVEEDORAE" FieldName="U_PROVEEDOR_AE" Name="fieldUPROVEEDORAE" Area="RowArea" AreaIndex="10">
            </dx:PivotGridField>
...
<dx:PivotGridField FieldName="XSLT_PERSONALIZADO" Name="fieldXSLTPERSONALIZADO" ID="fieldXSLTPERSONALIZADO" Visible="False" AreaIndex="0"></dx:PivotGridField>
            ...
            <dx:PivotGridField ID="fieldCUENTABANCO1" FieldName="CUENTA_BANCO1" Name="fieldCUENTABANCO1" Area="RowArea" AreaIndex="11">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldCUENTABANCO2" FieldName="CUENTA_BANCO2" Name="fieldCUENTABANCO2" Area="RowArea" AreaIndex="12">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldCUENTABANCO3" FieldName="CUENTA_BANCO3" Name="fieldCUENTABANCO3" Area="RowArea" AreaIndex="13">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldCUENTABANCO4" FieldName="CUENTA_BANCO4" Name="fieldCUENTABANCO4" Area="RowArea" AreaIndex="14">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldUCATEGORIAMDA" Area="RowArea" AreaIndex="26" FieldName="U_CATEGORIA_MDA" Name="fieldUCATEGORIAMDA" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldUCATEGORIARAMO" Area="RowArea" AreaIndex="26" FieldName="U_CATEGORIA_RAMO" Name="fieldUCATEGORIARAMO" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldUTIPOBLOQUEO" Area="RowArea" AreaIndex="26" FieldName="U_TIPO_BLOQUEO" Name="fieldUTIPOBLOQUEO" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldUCTABCOINTER" Area="RowArea" AreaIndex="15" FieldName="U_CTA_BCO_INTER" Name="fieldUCTABCOINTER">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldUNOMBCOINTER" Area="RowArea" AreaIndex="16" FieldName="U_NOM_BCO_INTER" Name="fieldUNOMBCOINTER">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldUDIRBCOINTER" Area="RowArea" AreaIndex="17" FieldName="U_DIR_BCO_INTER" Name="fieldUDIRBCOINTER">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldUABAOSWIFT" Area="RowArea" AreaIndex="18" FieldName="U_ABA_O_SWIFT" Name="fieldUABAOSWIFT">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldUIBANEURYCR1" Area="RowArea" AreaIndex="19" FieldName="U_IBAN_EUR_Y_CR" Name="fieldUIBANEURYCR1">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldUCLABEBANCMX" Area="RowArea" AreaIndex="20" FieldName="U_CLABE_BANC_MX" Name="fieldUCLABEBANCMX">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldUMONEDA" Area="RowArea" AreaIndex="21" FieldName="U_MONEDA" Name="fieldUMONEDA">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldUNOMBCOINTERM" Area="RowArea" AreaIndex="22" FieldName="U_NOM_BCO_INTERM" Name="fieldUNOMBCOINTERM">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldUABAOSWIFTBCOINTERM" Area="RowArea" AreaIndex="24" FieldName="U_ABA_O_SWIFT_BCO_INTERM" Name="fieldUABAOSWIFTBCOINTERM">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldUDIRBCOINTERM" Area="RowArea" AreaIndex="23" FieldName="U_DIR_BCO_INTERM" Name="fieldUDIRBCOINTERM">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldUCTABCOINTERM" Area="RowArea" AreaIndex="25" FieldName="U_CTA_BCO_INTERM" Name="fieldUCTABCOINTERM">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldUINSTRUCESPEC" Area="RowArea" AreaIndex="26" FieldName="U_INSTRUC_ESPEC" Name="fieldUINSTRUCESPEC" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldIMPUESTORENTA" Area="RowArea" AreaIndex="26" FieldName="IMPUESTO_RENTA" Name="fieldIMPUESTORENTA" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldRENTAASUMIDA" Area="RowArea" AreaIndex="26" FieldName="RENTA_ASUMIDA" Name="fieldRENTAASUMIDA" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldNUMRESCOACTIVA" Area="RowArea" AreaIndex="26" FieldName="NUM_RES_COACTIVA" Name="fieldNUMRESCOACTIVA" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldGRANDESCOMPRASEMT" Area="RowArea" AreaIndex="26" FieldName="GRANDES_COMPRA_SEMT" Name="fieldGRANDESCOMPRASEMT" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldTIPOSERVICIO" Area="RowArea" AreaIndex="26" FieldName="TIPO_SERVICIO" Name="fieldTIPOSERVICIO" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldITEMHACIENDACOMPRA1" Area="RowArea" AreaIndex="26" FieldName="ITEM_HACIENDA_COMPRA" Name="fieldITEMHACIENDACOMPRA1" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldCODIGOIMPUESTO1" Area="RowArea" AreaIndex="26" FieldName="CODIGO_IMPUESTO" Name="fieldCODIGOIMPUESTO1" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldREGIMENTRIB1" Area="RowArea" AreaIndex="26" FieldName="REGIMEN_TRIB" Name="fieldREGIMENTRIB1" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldALIAS1" Area="RowArea" AreaIndex="26" FieldName="ALIAS" Name="fieldALIAS1" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldCONTACTO1" Area="RowArea" AreaIndex="3" FieldName="CONTACTO" Name="fieldCONTACTO1">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldCARGO1" Area="RowArea" AreaIndex="26" FieldName="CARGO" Name="fieldCARGO1" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldDIRECCION1" Area="RowArea" AreaIndex="26" FieldName="DIRECCION" Name="fieldDIRECCION1" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldEMAIL1" Area="RowArea" AreaIndex="4" FieldName="E_MAIL" Name="fieldEMAIL1">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldTELEFONO11" Area="RowArea" AreaIndex="5" FieldName="TELEFONO1" Name="fieldTELEFONO11">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldINTERNACIONES1" Area="RowArea" AreaIndex="26" FieldName="INTERNACIONES" Name="fieldINTERNACIONES1" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldACEPTADOCELECTRONICO1" Area="RowArea" AreaIndex="26" FieldName="ACEPTA_DOC_ELECTRONICO" Name="fieldACEPTADOCELECTRONICO1" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldIMPUESTO1INCLUIDO1" Area="RowArea" AreaIndex="26" FieldName="IMPUESTO1_INCLUIDO" Name="fieldIMPUESTO1INCLUIDO1" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldPARTICIPAFLUJOCAJA1" Area="RowArea" AreaIndex="26" FieldName="PARTICIPA_FLUJOCAJA" Name="fieldPARTICIPAFLUJOCAJA1" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldPERMITEDOCGP1" Area="RowArea" AreaIndex="26" FieldName="PERMITE_DOC_GP" Name="fieldPERMITEDOCGP1" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldAUTORETENEDOR1" Area="RowArea" AreaIndex="26" FieldName="AUTORETENEDOR" Name="fieldAUTORETENEDOR1" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldMULTIMONEDA1" Area="RowArea" AreaIndex="26" FieldName="MULTIMONEDA" Name="fieldMULTIMONEDA1" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldPAIS1" Area="RowArea" AreaIndex="9" FieldName="PAIS" Name="fieldPAIS1">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldCONDICIONPAGO1" Area="RowArea" AreaIndex="7" FieldName="CONDICION_PAGO" Name="fieldCONDICIONPAGO1">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldFAX1" Area="RowArea" AreaIndex="26" FieldName="FAX" Name="fieldFAX1" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldLOCAL1" Area="RowArea" AreaIndex="26" FieldName="LOCAL" Name="fieldLOCAL1" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldTELEFONO21" Area="RowArea" AreaIndex="26" FieldName="TELEFONO2" Name="fieldTELEFONO21" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldAGENTERETENCION" Area="RowArea" AreaIndex="26" FieldName="AGENTE_RETENCION" Name="fieldAGENTERETENCION" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldBUENCONTRIBUYENTE" Area="RowArea" AreaIndex="26" FieldName="BUEN_CONTRIBUYENTE" Name="fieldBUENCONTRIBUYENTE" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldNUMIDENTNODOMIC" Area="RowArea" AreaIndex="26" FieldName="NUM_IDENT_NO_DOMIC" Name="fieldNUMIDENTNODOMIC" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldCONVENIO" Area="RowArea" AreaIndex="26" FieldName="CONVENIO" Name="fieldCONVENIO" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldDOMICILIADO" Area="RowArea" AreaIndex="26" FieldName="DOMICILIADO" Name="fieldDOMICILIADO" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldSISTEMAPENSIONES" Area="RowArea" AreaIndex="26" FieldName="SISTEMA_PENSIONES" Name="fieldSISTEMAPENSIONES" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldUSAPLAME" Area="RowArea" AreaIndex="26" FieldName="USA_PLAME" Name="fieldUSAPLAME" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldTIPOCF1" Area="RowArea" AreaIndex="26" FieldName="TIPO_CF" Name="fieldTIPOCF1" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldULTNUMENVIO" Area="RowArea" AreaIndex="26" FieldName="ULT_NUM_ENVIO" Name="fieldULTNUMENVIO" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldTIPONIT" Area="RowArea" AreaIndex="26" FieldName="TIPO_NIT" Name="fieldTIPONIT" Visible="False">
            </dx:PivotGridField>
        </Fields>
    </dx:ASPxPivotGrid>
