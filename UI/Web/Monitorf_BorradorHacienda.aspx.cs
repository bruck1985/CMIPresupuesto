...
namespace UI.Web
{
    ...
    public partial class Monitorf_BorradorHacienda : System.Web.UI.Page
    {
...
//                ((Lform.FindItemOrGroupByName("CiaOrigen") as LayoutItem).GetNestedControl() as ASPxGridLookup).Value = "";
            ...
            //XtraReport rpt = new UI.Web.XtraReportBorradorHaciendav2
            ...
            //XtraReport rpt2 = new UI.Web.XtraReportBorradorHaciendav2
            //{
            //    RequestParameters = false
            //    //RequestParameters = false
            //    //Parameters()
        ...
        protected void ASPxFormLayout1_E3_Click(object sender, EventArgs e)
        {
            ...
            //ASPxWebDocumentViewer1.ReportSourceId = UI.Web.XtraReportBorradorHaciendav2;
