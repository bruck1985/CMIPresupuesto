<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Menu.Master" AutoEventWireup="true" CodeBehind="ControlBancario.aspx.cs" Inherits="UI.Web.ControlBancario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" Text="Control Bancario"></asp:Label>
    <br />
    <br />
...
;Password=P0rta1R3p.2766$" ProviderName="System.Data.SqlClient" SelectCommand="PORTAL.[dbo].[PORTAL_CONTROL_BANCARIO]" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="%" Name="PCia" SessionField="ci_sciaCB" />
    ...
    <dx:ASPxGridView ID="grid_data"  ClientInstanceName="MasterGrid" runat="server" Width="1324px" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="MONEDA" VisibleIndex="12" ShowInCustomizationForm="True" Caption="Moneda">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="DEBITO" VisibleIndex="13" ShowInCustomizationForm="True" Caption="Debito">
                <PropertiesTextEdit DisplayFormatString="{0:N2}" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="CREDITO" VisibleIndex="14" ShowInCustomizationForm="True" Caption="Credito">
                <PropertiesTextEdit DisplayFormatString="{0:N2}" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="USUARIO_APROBACION" VisibleIndex="16" ShowInCustomizationForm="True" Caption="Usuario Aprobacion">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="FECHA_APROBACION" VisibleIndex="17" ShowInCustomizationForm="True" Caption="Fecha Aprobacion">
                <PropertiesTextEdit DisplayFormatString="dd/MM/yyyy">  
                </PropertiesTextEdit>
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="SALDO_CUENTA" VisibleIndex="18" ShowInCustomizationForm="True" Caption="Saldo Cuenta">
                <PropertiesTextEdit DisplayFormatString="{0:N2}" />
            </dx:GridViewDataTextColumn>
        </Columns>
    </dx:ASPxGridView>
    ...
    <dx:ASPxGridViewExporter ID="grid_data_exp" runat="server" FileName="Control_Bancario" GridViewID="grid_data">
