...
namespace UI.Web
{
    public partial class ProveedoresV3 : System.Web.UI.Page
    {
...
//                ((Lform.FindItemOrGroupByName("CiaOrigen") as LayoutItem).GetNestedControl() as ASPxGridLookup).Value = "";
                ...
                ((Lform.FindItemOrGroupByName("CB_Tipo_Reporte") as LayoutItem).GetNestedControl() as ASPxComboBox).Value = "S";
...
//                Session["ci_sfec2"] = CBFechaFinal.Value != null ? CBFechaFinal.Date.ToString("dd/MM/yyyy") : string.Empty;
                Session["pv_estado"] = CBtiporep.Value != null ? CBtiporep.Value.ToString() : string.Empty;
        ...
        protected void ASPxFormLayout1_E3_ClickExc(object sender, EventArgs e)
        {
            ...
            WriteToResponse("ReporteProveedores.xlsx", true, "vnd.openxmlformats-officedocument.spreadsheetml.sheet", stream);
