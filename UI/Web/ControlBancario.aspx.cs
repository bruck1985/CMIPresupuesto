...
namespace UI.Web
{
    public partial class ControlBancario : System.Web.UI.Page
    {
        ...
        {
            if (Session["ci_sciaCB"] == null)
            {
                Session["ci_sciaCB"] = "ddd ffffff";
        ...
        private void BuscarDocumentos()
        {
            ...
            if (CBFechaInicial != null)
            {
                ...
                if (CBCia.Value != null)
                {
                    Session["ci_sciaCB"] = CBCia.Value != null ? CBCia.Value.ToString() : "XXX;";
                }
                else
                {
                    Session["ci_sciaCB"] = "XXX XXXXXXXXXX";
                }
