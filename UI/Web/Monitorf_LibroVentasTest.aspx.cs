...
namespace UI.Web
{
    public partial class Monitorf_LibroVentasTest : System.Web.UI.Page
    {
...
//                ((Lform.FindItemOrGroupByName("CiaOrigen") as LayoutItem).GetNestedControl() as ASPxGridLookup).Value = "";
        ...
        protected void ASPxFormLayout1_E3_ClickExc(object sender, EventArgs e)
        {
            ...
            GridVentas.ExportToXlsx(stream);
            WriteToResponse("LibroVenta.xlsx", true, "vnd.openxmlformats-officedocument.spreadsheetml.sheet", stream);
