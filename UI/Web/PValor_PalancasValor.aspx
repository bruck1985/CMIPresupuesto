<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Menu.Master" AutoEventWireup="true" CodeBehind="PValor_PalancasValor.aspx.cs" Inherits="UI.Web.PValor_PalancasValor" %>
...
WHERE Activo=1">
    ...
    <br />
     <dx:ASPxGridView ID="GridPalancas" runat="server" AutoGenerateColumns="False" DataSourceID="SQLPalancas"  KeyFieldName="CONSECUTIVO" Theme="SoftOrange">
           ...
           <dx:GridViewDataComboBoxColumn FieldName="Periodo" LoadReadOnlyValueFromDataModel="True" VisibleIndex="2" Width="70px">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CodigoTema" LoadReadOnlyValueFromDataModel="True" VisibleIndex="6" Caption="Temas" Width="100px">
                <PropertiesComboBox DataSourceID="SQLTemas" TextField="Tema" ValueField="CodigoTema">
                    ...
                    <dx:GridViewDataMemoColumn FieldName="OrigenEvento" VisibleIndex="7" Width="100px">
            ...
            <dx:GridViewDataTextColumn FieldName="MontoImpactoUNAPeriodo" LoadReadOnlyValueFromDataModel="True" VisibleIndex="12" Caption="MontoImpactoUNAPeriodo (miles)" Width="100px">
            </dx:GridViewDataTextColumn>
<%--            <dx:GridViewDataTextColumn FieldName="CodigoImpactoUNAPeriodo" LoadReadOnlyValueFromDataModel="True" VisibleIndex="13" ReadOnly="True">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CodigoImpactoUNAPeriodo" LoadReadOnlyValueFromDataModel="True" VisibleIndex="13" Caption="ImpactoUNAPeriodo" Width="110px">
                <PropertiesComboBox DataSourceID="SQLImpactos" TextField="Impacto" ValueField="CodigoImpacto">
                </PropertiesComboBox>
                <EditFormSettings Visible="False" />
            </dx:GridViewDataComboBoxColumn>  

            <dx:GridViewDataTextColumn FieldName="MontoImpactoCajaPeriodo" LoadReadOnlyValueFromDataModel="True" VisibleIndex="14" Caption="MontoImpactoCajaPeriodo (miles)" Width="100px">
            </dx:GridViewDataTextColumn>
...
<%--            <dx:GridViewDataTextColumn FieldName="CodigoImpactoCajaPeriodo" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="15">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CodigoImpactoCajaPeriodo" LoadReadOnlyValueFromDataModel="True" VisibleIndex="15" Caption="ImpactoCajaPeriodo" Width="110px">
                <PropertiesComboBox DataSourceID="SQLImpactos" TextField="Impacto" ValueField="CodigoImpacto">
                </PropertiesComboBox>
                <EditFormSettings Visible="False" />
            </dx:GridViewDataComboBoxColumn>

            <dx:GridViewDataTextColumn FieldName="MontoImpactoUNALP" LoadReadOnlyValueFromDataModel="True" VisibleIndex="16" Caption="MontoImpactoUNALP (miles)" Width="100px">
            </dx:GridViewDataTextColumn>
<%--            <dx:GridViewDataTextColumn FieldName="CodigoImpactoUNALP" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="17">
                <EditFormSettings Visible="False" />
            </dx:GridViewDataTextColumn>--%>
            <dx:GridViewDataComboBoxColumn FieldName="CodigoImpactoUNALP" LoadReadOnlyValueFromDataModel="True" VisibleIndex="17" Caption="ImpactoUNALP" Width="110px">
                <PropertiesComboBox DataSourceID="SQLImpactos" TextField="Impacto" ValueField="CodigoImpacto">
                </PropertiesComboBox>
                <EditFormSettings Visible="False" />
            </dx:GridViewDataComboBoxColumn>

            <dx:GridViewDataTextColumn FieldName="MontoImpactoCajaLP" LoadReadOnlyValueFromDataModel="True" VisibleIndex="18" Caption="MontoImpactoCajaLP (miles)" Width="100px">
            </dx:GridViewDataTextColumn>
<%--            <dx:GridViewDataTextColumn FieldName="CodigoImpactoCajaLP" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="19">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CodigoImpactoCajaLP" LoadReadOnlyValueFromDataModel="True" VisibleIndex="19" Caption="ImpactoCajaLP" Width="110px">
                <PropertiesComboBox DataSourceID="SQLImpactos" TextField="Impacto" ValueField="CodigoImpacto">
                </PropertiesComboBox>
                <EditFormSettings Visible="False" />
            </dx:GridViewDataComboBoxColumn>
...
<%--            <dx:GridViewDataTextColumn FieldName="CodigoProbabilidadOcurrenciaRiesgoInherente" LoadReadOnlyValueFromDataModel="True" VisibleIndex="20">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CodigoProbabilidadOcurrenciaRiesgoInherente" LoadReadOnlyValueFromDataModel="True" VisibleIndex="20" Caption="ProbabilidadOcurrenciaRiesgoInherente" Width="120px">
                <PropertiesComboBox DataSourceID="SQLProbabilidades" TextField="Probabilidad" ValueField="CodigoProbabilidad">
                </PropertiesComboBox>
            </dx:GridViewDataComboBoxColumn>

            <dx:GridViewDataTextColumn FieldName="MontoImpactoRiesgoInherente" LoadReadOnlyValueFromDataModel="True" VisibleIndex="21" Caption="MontoImpactoRiesgoInherente (miles)" Width="100px">
            </dx:GridViewDataTextColumn>
<%--            <dx:GridViewDataTextColumn FieldName="CodigoImpactoRiesgoInherente" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="22">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CodigoImpactoRiesgoInherente" LoadReadOnlyValueFromDataModel="True" VisibleIndex="22" Caption="ImpactoRiesgoInherente" Width="110px">
                <PropertiesComboBox DataSourceID="SQLImpactos" TextField="Impacto" ValueField="CodigoImpacto">
                </PropertiesComboBox>
                <EditFormSettings Visible="False" />
            </dx:GridViewDataComboBoxColumn>
...
<%--            <dx:GridViewDataTextColumn FieldName="CodigoCriticidadRiesgoInherente01" LoadReadOnlyValueFromDataModel="True" VisibleIndex="23">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CodigoCriticidadRiesgoInherente01" ReadOnly="True" LoadReadOnlyValueFromDataModel="True" VisibleIndex="23" Caption="IndiceCriticidadRiesgoInherente" Width="170px">
                <PropertiesComboBox DataSourceID="SQLCriticidades" TextField="Criticidad" ValueField="CodigoCriticidad">
                </PropertiesComboBox>
                <EditFormSettings Visible="False" />
            </dx:GridViewDataComboBoxColumn>

            <dx:GridViewDataTextColumn FieldName="CodigoCriticidadRiesgoInherente02" LoadReadOnlyValueFromDataModel="True" VisibleIndex="24" Caption="CriticidadRiesgoInherente" Width="80px">
            </dx:GridViewDataTextColumn>
...
<%--            <dx:GridViewDataTextColumn FieldName="CodigoProbabilidadOcurrenciaRiesgoResidual" LoadReadOnlyValueFromDataModel="True" VisibleIndex="26">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CodigoProbabilidadOcurrenciaRiesgoResidual" LoadReadOnlyValueFromDataModel="True" VisibleIndex="26" Caption="ProbabilidadOcurrenciaRiesgoResidual" Width="100px">
                <PropertiesComboBox DataSourceID="SQLProbabilidades" TextField="Probabilidad" ValueField="CodigoProbabilidad">
                </PropertiesComboBox>
            </dx:GridViewDataComboBoxColumn>

            <dx:GridViewDataTextColumn FieldName="MontoImpactoRiesgoResidualUNA" LoadReadOnlyValueFromDataModel="True" VisibleIndex="27" Caption="MontoImpactoRiesgoResidualUNA (miles)" Width="100px">
            </dx:GridViewDataTextColumn>
<%--            <dx:GridViewDataTextColumn FieldName="CodigoImpactoRiesgoResidualUNA" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="28">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CodigoImpactoRiesgoResidualUNA" LoadReadOnlyValueFromDataModel="True" VisibleIndex="28" Caption="ImpactoRiesgoResidualUNA" Width="100px">
                <PropertiesComboBox DataSourceID="SQLImpactos" TextField="Impacto" ValueField="CodigoImpacto">
                </PropertiesComboBox>
                <EditFormSettings Visible="False" />
            </dx:GridViewDataComboBoxColumn>

            <dx:GridViewDataTextColumn FieldName="MontoImpactoRiesgoResidualFlujo" LoadReadOnlyValueFromDataModel="True" VisibleIndex="29" Caption="MontoImpactoRiesgoResidualFlujo (miles)" Width="100px">
            </dx:GridViewDataTextColumn>
<%--            <dx:GridViewDataTextColumn FieldName="CodigoImpactoRiesgoResidualFlujo" LoadReadOnlyValueFromDataModel="True" ReadOnly="True" VisibleIndex="30">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CodigoImpactoRiesgoResidualFlujo" LoadReadOnlyValueFromDataModel="True" VisibleIndex="30" Caption="ImpactoRiesgoResidualFlujo" Width="100px">
                <PropertiesComboBox DataSourceID="SQLImpactos" TextField="Impacto" ValueField="CodigoImpacto">
                </PropertiesComboBox>
                <EditFormSettings Visible="False" />
            </dx:GridViewDataComboBoxColumn>
...
<%--            <dx:GridViewDataTextColumn FieldName="CodigoCriticidadRiesgoResidual01" LoadReadOnlyValueFromDataModel="True" VisibleIndex="31">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CodigoCriticidadRiesgoResidual01" ReadOnly="True" LoadReadOnlyValueFromDataModel="True" VisibleIndex="31" Caption="IndiceCriticidadRiesgoResidual" Width="170px">
                <PropertiesComboBox DataSourceID="SQLCriticidades" TextField="Criticidad" ValueField="CodigoCriticidad">
                </PropertiesComboBox>
                <EditFormSettings Visible="False" />
            </dx:GridViewDataComboBoxColumn>

            <dx:GridViewDataTextColumn FieldName="CodigoCriticidadRiesgoResidual02" LoadReadOnlyValueFromDataModel="True" VisibleIndex="32" Caption="CriticidadRiesgoResidual" Width="80px">
            </dx:GridViewDataTextColumn>
<%--            <dx:GridViewDataComboBoxColumn FieldName="CodigoCriticidadRiesgoResidual02" ReadOnly="True" LoadReadOnlyValueFromDataModel="True" VisibleIndex="32" Caption="CriticidadRiesgoResidual" Width="120px">
            ...
            <dx:GridViewDataDateColumn FieldName="PlazoResolucion" LoadReadOnlyValueFromDataModel="True" VisibleIndex="33" Width="100px">
            </dx:GridViewDataDateColumn>
<%--                    <dx:GridViewDataTextColumn FieldName="AccionesCursoEnergia" LoadReadOnlyValueFromDataModel="True" VisibleIndex="34">
            </dx:GridViewDataTextColumn>--%>
                    <dx:GridViewDataMemoColumn FieldName="AccionesCursoEnergia" VisibleIndex="34" Width="100px">
                        <PropertiesMemoEdit Height="80px" MaxLength="500">
                        </PropertiesMemoEdit>
                        <Settings AllowEllipsisInText="True" />
                    </dx:GridViewDataMemoColumn>
...
<%--            <dx:GridViewDataTextColumn FieldName="AccionesAltoNivel" LoadReadOnlyValueFromDataModel="True" VisibleIndex="35">
                    ...
                    <dx:GridViewDataMemoColumn FieldName="AccionesAltoNivel" VisibleIndex="35" Width="100px">
                        <PropertiesMemoEdit Height="80px" MaxLength="500">
                            <Style Wrap="True">
                            </Style>
                        </PropertiesMemoEdit>
...
<%--            <dx:GridViewDataTextColumn FieldName="CodigoEstadoPalanca" LoadReadOnlyValueFromDataModel="True" VisibleIndex="36">
            ...
            <dx:GridViewDataComboBoxColumn FieldName="CodigoEstadoPalanca" LoadReadOnlyValueFromDataModel="True" VisibleIndex="36" Caption="EstadoPalanca">
