<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Menu.Master" AutoEventWireup="true" CodeBehind="Monitorf_BorradorHaciendaTest.aspx.cs" Inherits="UI.Web.Monitorf_BorradorHaciendaTest" %>
...
<%@ Register assembly="DevExpress.XtraReports.v18.2.Web.WebForms, Version=18.2.14.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.XtraReports.Web.WebDocumentViewer" tagprefix="cc2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" Text="              Borrador de Impuesto de Venta"></asp:Label>
    <br />
<%--    <br />--%>
            ...
            <dx:LayoutGroup ColCount="7" ColSpan="1" ColumnCount="7" Caption="Defina Parametros" RowSpan="2">
                <Items>
                    ...
                    <dx:LayoutItem Caption="" ColSpan="1" Name="Excel" Width="40px">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <dx:ASPxButton ID="Lform_E1" runat="server" Height="32px" Native="True" OnClick="ASPxFormLayout1_E3_ClickExc" Theme="SoftOrange" Width="32px" ToolTip="Exportar Excel" Visible="False">
...
" Name="PUsuarioCia" SessionField="nombreUsuario" Size="200" Type="String" />
    ...
    <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Small" Text="              Reporte" Visible="False"></asp:Label>
<%--    <br />--%>


   <%--          <br />--%>
    <dx:ASPxWebDocumentViewer ID="ASPxWebDocumentViewer1Test" runat="server" DisableHttpHandlerValidation="False">
