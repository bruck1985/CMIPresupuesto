<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Menu.Master" AutoEventWireup="true" CodeBehind="Comprasv3.aspx.cs" Inherits="UI.Web.Comprasv3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" Text="              Visualización Ordenes de Compras"></asp:Label>
    <br />
    <br />
    ...
    <asp:SqlDataSource ID="SQLCompras" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConexionPruebas %>" ProviderName="<%$ ConnectionStrings:SQLConexionPruebas.ProviderName %>" SelectCommand="PORTAL.[dbo].PORTAL_COMPRASV2b" SelectCommandType="StoredProcedure">
        <SelectParameters>
...
order by 2">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="JMZ" Name="PUsuarioCia" SessionField="nombreUsuario" Size="200" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="SQLDepartamento" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConexionPruebas %>" ProviderName="<%$ ConnectionStrings:SQLConexionPruebas.ProviderName %>" SelectCommand="PORTAL.[dbo].[PORTAL_DEPARTAMENTO_USUARIO]" SelectCommandType="StoredProcedure">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="SQLDepartamento2" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConexionPruebas %>" ProviderName="<%$ ConnectionStrings:SQLConexionPruebas.ProviderName %>" SelectCommand="select CIA+'-'+DEPARTAMENTO DEPARTAMENTO, CIA+'-'+DEPARTAMENTO + ' ' + DESC_DEPARTAMENTO DESC_DEPARTAMENTO
                                    ...
                                    <dx:LayoutGroup Caption=" " ColCount="3" ColSpan="1" ColumnCount="3" GroupBoxDecoration="HeadingLine" UseDefaultPaddings="True" Width="185px">
                                        <Items>
                                            <dx:LayoutItem Caption="" ColSpan="1" Name="Por Aprobar" Width="16px" HorizontalAlign ="Left">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxButton ID="ASPxFormLayout1_E2" runat="server" ToolTip="Por Aprobar Orden" AutoPostBack="False" Visible="False" >
                                                            <ClientSideEvents Click="function(s, e) {
	PDialogo.Show();
}" />
                                            ...
                                            <dx:LayoutItem Caption="" ColSpan="1" Name="Aprobar" Width="16px"  HorizontalAlign ="Left">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxButton ID="ASPxFormLayout1_E4" runat="server" ToolTip="Aprobar Orden" AutoPostBack="False" Visible="False" >
                                                            <ClientSideEvents Click="function(s, e) {
	PDialogo2.Show();
                                            ...
                                            <dx:LayoutItem Caption="" ColSpan="1" Name="Reversar" Width="16px"  HorizontalAlign ="Left">
                                                <LayoutItemNestedControlCollection>
                                                    <dx:LayoutItemNestedControlContainer runat="server">
                                                        <dx:ASPxButton ID="ASPxFormLayout1_E1" runat="server" ToolTip="Reversar Orden de Compra" AutoPostBack="False" Visible="False" >
                                                            <ClientSideEvents Click="function(s, e) {
		PDialogo3.Show();
}" />
                        ...
                        <SettingsItemCaptions Location="Left" />
                            ...
                            <td>    <dx:ASPxFileManager ID="ASPxFileManager1" runat="server" DataSourceID="SQL_Data_OC_Doc_Adjuntos" Height="380px" Width="200px" OnFileDownloading="ASPxFileManager1_FileDownloading" ClientInstanceName="filemanager" OnCustomCallback="ASPxFileManager1_CustomCallback">
        <SettingsDataSource />
...
<PropertiesTextEdit DisplayFormatString="#,###.00"></PropertiesTextEdit>
                    ...
                    <div>
                        ...
                        <asp:SqlDataSource ID="SQL_Data_CTA_Detalle1" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConexionPruebas %>" ProviderName="<%$ ConnectionStrings:SQLConexionPruebas.ProviderName %>" SelectCommand="PORTAL.[dbo].[PORTAL_COMPRASV2_Detalle]" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                        ...
                        <asp:SqlDataSource ID="SQL_Data_OC_Linea" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConexionPruebas %>" ProviderName="<%$ ConnectionStrings:SQLConexionPruebas.ProviderName %>" SelectCommand="PORTAL.[dbo].[PORTAL_COMPRASV2_Detalle_linea]" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                                <asp:SessionParameter DefaultValue="CROMSA" Name="PCia1" SessionField="cov2_cia" Type="String" />
                                <asp:Parameter DefaultValue="OC009242" Name="POrden_Compra" Type="String" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                        <asp:SqlDataSource ID="SQL_Data_OC_Doc_Adjuntos" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConexionPruebas %>" ProviderName="<%$ ConnectionStrings:SQLConexionPruebas.ProviderName %>" SelectCommand="PORTAL.[dbo].[PORTAL_DOCUMENTOS_ADJUNTOS_OC]" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                                <asp:SessionParameter DefaultValue="CROMSA" Name="PCia1" SessionField="cov2_cia" Type="String" />
